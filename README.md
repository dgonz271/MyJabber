# Project 2 - *MyJabber* Part 2

**MyJabber** is an android app that allows a user to view their Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
Describe any challenges encountered while building the app.
Attempting the Infinite Pagination was difficult, could not get it to work.
